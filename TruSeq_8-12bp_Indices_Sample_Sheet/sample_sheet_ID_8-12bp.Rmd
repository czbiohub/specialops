...
filename <- "../TruSeq_8-12bp_Indices_Sample_Sheet/CZB-Sample-Input-Test.csv"
...
Study_ID_fill <- "TB-FLASH"
Study_Description_fill <- "CSF DNA seq of patients with TB/HIV co-infection as controls for future FLASHed samples"
BioSample_ID_fill <- "TB-FLASH-CSF-DNA"
BioSample_Description_fill <- "Cerebrospinal fluid"
Sample_Owner_fill <- "Amy Lyden"
Organism_fill <- "mycobacterium tuberculosis"
Host_fill <- "human"
Gender_fill <- ""
Tissue_Source_fill <- ""
FACS_Markers_fill <- ""
...
Metadata Step 2 of 2: This section will pull in the metadata from your sample sheet and the populate empty cells with the values from Metadata Step 2. Do not edit below this line, you can now press *OPTION+CMD+R* or *RUN ALL* under *Run* in the upper right of the script.
