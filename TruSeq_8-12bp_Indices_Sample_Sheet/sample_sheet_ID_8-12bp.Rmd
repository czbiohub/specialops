...
filename <- "../TruSeq_8-12bp_Indices_Sample_Sheet/CZBTest12bp.csv"
...
```{r}
dualindices <- read_csv(file ="2018-11-02-TRUSEQ-8-12BP-INDEX-PRIMERS-PLATES-001-to-012-MasterIndexList-FULL.csv")
```
