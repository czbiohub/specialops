...
filename <- "../../../Sample Sheets/RT-FLASH-003_SampleSheet_Input.csv"
...
Study_ID_fill <- "RT-FLASH"
Study_Description_fill <- "Experimenting with cDNA kits on Pseudomonas and Ecoli isolates for compatibility with FLASH"
BioSample_ID_fill <- ""
BioSample_Description_fill <- ""
